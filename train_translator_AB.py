...
if __name__ == '__main__':
    ...
    parser.add_argument("--resume_epoch", type=int, default=262, help="epoch to resume training")                  # 改！！！！！！！！！！！！！！！！！！！！！
    ...
    parser.add_argument("--save_checkpoint", type=int, default=1, help="checkpoint for visual inspection")
    ...
    if opt.resume_epoch > 0:
        translator.load_state_dict(torch.load("./best_rmse_model/DistillNet_261.pth"))    # 改！！！！！！！！！！！！！！！！！！！！！
        optimizer_G.load_state_dict(torch.load("./best_rmse_model/optimizer_261.pth"))    # 改！！！！！！！！！！！！！！！！！！！！！
        ...
        if (epoch + 1) % opt.valid_checkpoint == 0 or epoch in [0, 1]:
            with torch.no_grad():
                ...
                for idx, (B_img, AB_mask, A_img) in enumerate(val_dataloader):
                    ...
                    if (epoch + 1) % opt.save_checkpoint == 0:
                        output_folder = "./save_checkpoint/{}/".format(epoch)
